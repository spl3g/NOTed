...
const NoteResponseSchema = t.Object({
  ...
  accessType: t.Optional(t.Union([t.Literal('owned'), t.Literal('shared'), t.Literal('public')])),
});
...
export const userRoutes = new Elysia({ prefix: '/users' })
  .use(requireAuth)
  .get('/:id/notes', async ({ params, auth, set }) => {
    ...
    detail: {
      ...
      description: 'Get all notes owned by a specific user. Users can only access their own notes',
      tags: ['Users'],
    },
  });